# 📄 Relatório Final
> **Documento detalhado de suporte à avaliação técnica e percurso de aprendizagem.**
...
## 🚀 8. Sugestões de Melhoria e Trabalho Futuro
...
* **Comparação de Fornecedores:** Avaliar a viabilidade de manter a stack em instâncias **Free Tier** (ex: Oracle Cloud) vs. a migração para serviços geridos (ex: AWS RDS/Google Cloud SQL/Azure ) à medida que o tráfego escala.
